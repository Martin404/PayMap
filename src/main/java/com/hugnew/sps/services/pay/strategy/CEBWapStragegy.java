 ...
 */
public class CEBWapStragegy implements PayStrategy {

    private static Logger logger = LoggerFactory.getLogger(CEBWapStragegy.class);
    ...
    public String generatePayParams(PayType payType, Map<String, Object> params) {
        ...
        toRet.put("transName", PropertiesUtil.getValue("pay.request.ceb.wap.transName"));

 ...
 */
public class PSBCWebStragegy implements PayStrategy {

    private static Logger logger = LoggerFactory.getLogger(PSBCWebStragegy.class);
    ...
    public String generatePayParams(PayType payType, Map<String, Object> params) {
        ...
        plainMap.put("TranAbbr", PropertiesUtil.getValue("pay.request.psbc.web.TranAbbr"));
        ...
        toRet.put("transName", PropertiesUtil.getValue("pay.request.psbc.web.transName"));

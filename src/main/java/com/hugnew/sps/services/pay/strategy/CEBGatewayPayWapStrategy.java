 ...
 */
public class CEBGatewayPayWapStrategy implements PayStrategy {

    private static Logger logger = LoggerFactory.getLogger(CEBGatewayPayWapStrategy.class);
    ...
    public String generatePayParams(PayType payType, Map<String, Object> params) {
        ...
        toRet.put("url", PropertiesUtil.getValue("pay.request.cebGateway.wap.url"));

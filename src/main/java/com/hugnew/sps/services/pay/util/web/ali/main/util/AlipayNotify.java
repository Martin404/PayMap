...
public class AlipayNotify {
    ...
    private static boolean getSignVeryfy(Map<String, String> Params, String sign) {
        ...
        if (PropertiesUtil.getValue("pay.request.alipayWebMain.sign_type").equals("MD5")) {
            isSign = MD5.verify(preSignStr, sign, PropertiesUtil.getValue("pay.request.alipayWebMain.key"), PropertiesUtil.getValue("pay.request.alipayWebMain.input_charset"));
        }
        return isSign;
    }
    ...
    private static String verifyResponse(String notify_id) {
        ...
        String partner = PropertiesUtil.getValue("pay.request.alipayWebMain.partner");
